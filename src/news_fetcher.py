...
CORE_KEYWORDS = {
    ...
    # ── 方向二.五：資本支出 / 擴產（2026-08-24新增，基本面轉折訊號）──
    # 管理層宣布擴產/資本支出通常領先股價反映數個月，是提早偵測基本面轉折的線索
    "資本支出":      ["資本支出", "capex", "資本支出計畫", "增加投資"],
    "擴產":          ["擴產", "擴廠", "新產能", "產能擴充", "增設產線", "新建廠房", "設新廠"],

    # ── 方向二.六：庫存循環（2026-08-24新增，產業轉折訊號）──
    # 庫存去化/回補循環通常領先股價反轉1-2季，是判斷景氣循環股進出場時機的重要線索
    "庫存去化":      ["庫存去化", "去化庫存", "庫存調整", "庫存修正"],
    "庫存回補":      ["庫存回補", "回補庫存", "拉貨動能", "急單", "回補訂單"],
    "稼動率":        ["稼動率", "產能利用率", "滿載", "產線利用率"],
    "砍單":          ["砍單", "訂單縮減", "需求疲弱", "拉貨轉弱"],
